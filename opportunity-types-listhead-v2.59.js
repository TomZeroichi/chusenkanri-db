...
@media(min-width:700px){#'+MODAL_ID+'{align-items:center}#'+MODAL_ID+' .tom-sheet{border-radius:20px}}';
  ...
  function ensureNav(){
    ...
    if(!nav){
      ...
      var listHead=member.querySelector('.list-head');if(listHead&&listHead.parentNode)listHead.parentNode.insertBefore(nav,listHead);else{var toolbar=member.querySelector('.toolbar');if(toolbar&&toolbar.parentNode)toolbar.parentNode.insertBefore(nav,toolbar);else member.insertBefore(nav,member.firstChild);}
