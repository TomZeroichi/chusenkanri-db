...
';
  ...
  function loadState(){
    ...
    }).catch(function(err){console.warn('[TOM V2.39] member polish load failed',err);var readyList=document.getElementById('lotteryList');if(readyList)readyList.style.visibility='';});
  }
